...
def get_names():
	get_page = r.get(f"https://www.nhlstreams100.com/")
	...
	get_page2 = r.get(f"https://www.nhlstreams100.com/page/2/")
...
class send_names(commands.Cog):
	...
	async def nhlnames(self,ctx):
		...
		em.set_footer(text= f"Requested By: {ctx.author.name}#{ctx.author.discriminator} • !nhlnames", icon_url=f"{ctx.author.avatar_url}")
